...
public interface CommonConstant {
	...
	/** 二级库接口token */
	public static final String SECONDARY_TOKEN = "secondary_token";

	/** Token缓存时间：3600秒即一小时 */
	public static final int TOKEN_EXPIRE_TIME = 3600;

	/** Token缓存时间：7000秒 */
	public static final int TOKEN_EXPIRE_TIME_7000 = 120;

	/** Token缓存时间：600 */
	public static final int TOKEN_EXPIRE_TIME_1800 = 1800;
