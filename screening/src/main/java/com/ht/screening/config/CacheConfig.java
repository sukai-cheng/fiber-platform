...
import com.ht.screening.config.properties.CacheExpireTimeConfig;
...
{
    @Autowired
    private CacheExpireTimeConfig cacheExpireTimeConfig;
    ...
    public RedisCacheManager redisCacheManager(RedisTemplate redisTemplate) {
        ...
        if (cacheExpireTimeConfig != null && cacheExpireTimeConfig.getTtl() != null && cacheExpireTimeConfig.getTtl().size() > 0 ){
            Map<String, RedisCacheConfiguration> configurationMap = new HashMap<>();
            cacheExpireTimeConfig.getTtl().forEach((cacheName,cacheTtl)->
